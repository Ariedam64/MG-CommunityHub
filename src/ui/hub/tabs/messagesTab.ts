...
import { sendMessage, markMessagesRead } from "@/api/endpoints/messages";
import { sendGroupMessage, markGroupMessagesAsRead } from "@/api/endpoints/groups";
import type { CachedFriendConversation, CachedGroupConversation, CachedDirectMessage, CachedGroupMessage } from "@/api";
import type { DirectMessage, GroupMessage } from "@/api/types";
...
import { isDiscordSurface } from "@/platform/api";
