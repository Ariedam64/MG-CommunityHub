import { getCachedMyProfile, updateCachedMyProfilePrivacy } from "@/api/cache/welcome";
import { onWelcome, updatePrivacy } from "@/api";
import type { PlayerPrivacyPayload } from "@/api/types";
