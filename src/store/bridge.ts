...
//
// Problem: two userscripts (this hub + Arie's Mod) must NOT both run the
// "write-once" store capture (it temporarily patches atom.write on every atom
// in jotaiAtomCache — two concurrent patchers can corrupt each other).
//
